...
const SYSTEM = [
  ...
  "- Add a one-line doc-string annotation immediately before the source declaration using Malloy's #\"...\" syntax. Keep it under 120 characters.",
  "",
  "EXAMPLE SHAPE:",
  "",
  '#"Yellow taxi trips in NYC — fare, tip, distance, and pickup/dropoff location analysis."',
